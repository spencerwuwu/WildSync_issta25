...
if (_IN_BUFFER_SIZE < sizeof(HPDF_ExtGState) + 1) {
	return 0;
}
HPDF_ExtGState __fuzz_0;
memcpy(&__fuzz_0, _IN_BUFFER + _BUF_POINTER, sizeof(HPDF_ExtGState));
_BUF_POINTER += sizeof(HPDF_ExtGState);
...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_page_operator.c_0
// TODO: very hacky. Who knows whether this will work
int __HPDF_ExtGState = 5;
