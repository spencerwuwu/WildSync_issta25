...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_encoder_kr.c_0
// TODO: very hacky. Who knows whether this will work
int __pdf__mmgr = 5;
int __KSCms_UHC_H_Init = 5;
int __KSCms_UHC_HW_H_Init = 5;
int __KSCms_UHC_HW_V_Init = 5;
int __KSC_EUC_H_Init = 5;
int __KSC_EUC_V_Init = 5;
 HPDF_Encoder encoder;
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"KSCms-UHC-H", __KSCms_UHC_H_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"KSCms-UHC-HW-H", __KSCms_UHC_HW_H_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"KSCms-UHC-HW-V", __KSCms_UHC_HW_V_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"KSC-EUC-H", __KSC_EUC_H_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"KSC-EUC-V", __KSC_EUC_V_Init );
