...
if (_IN_BUFFER_SIZE < sizeof(TIFFFieldInfo*) + sizeof(char*) + 1) {
	return 0;
}
size_t _IN_REMAIN_LEN = (_IN_BUFFER_SIZE - _BUF_POINTER) / 3;

TIFFFieldInfo* __fuzz_0 = (TIFFFieldInfo*) (_IN_BUFFER + _BUF_POINTER);
...
// Extracted from: imagemagick: coders/tiff.c_0
 ...
 ignore = ( TIFFFieldInfo * ) __fuzz_0;
 ( void )TIFFMergeFieldInfo(tif,  ignore,  ( uint32 ) count);
