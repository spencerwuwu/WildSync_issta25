...
// Extracted from: gthumb: extensions/cairo_io/cairo-image-surface-png.c_0
 * original_height =png_get_image_height(png_handler.png_ptr, png_handler.info_ptr);
