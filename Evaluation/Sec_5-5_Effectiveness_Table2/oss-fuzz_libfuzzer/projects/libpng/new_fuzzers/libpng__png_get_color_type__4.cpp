...
// Extracted from: synfig: synfig-core/src/modules/mod_png/trgt_png_spritesheet.cpp_1
 if ( (png_get_color_type(png_handler.png_ptr, png_handler.info_ptr) != PNG_COLOR_TYPE_RGBA ) ){
}
