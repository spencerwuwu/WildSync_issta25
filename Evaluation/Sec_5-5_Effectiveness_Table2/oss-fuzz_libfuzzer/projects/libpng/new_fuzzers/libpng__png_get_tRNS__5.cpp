...
// Extracted from: sdl2_image: external/libpng/contrib/examples/pngpixel.c_0
// TODO: very hacky. Who knows whether this will work
int __PNG_INFO_tRNS = 5;
 png_bytep trans_alpha = NULL;
 int num_trans = 0;
 if ( ( (png_get_tRNS(png_handler.png_ptr, png_handler.info_ptr,  & trans_alpha,  & num_trans,  NULL) & __PNG_INFO_tRNS ) && num_trans > 0 && trans_alpha != NULL ) ){
}
