...
// Extracted from: libheif: examples/decoder_png.cc_0
// TODO: very hacky. Who knows whether this will work
int __PNG_INFO_eXIf = 5;
{
}
 png_bytep exifPtr = nullptr;
 if ( (png_get_eXIf_1(png_handler.png_ptr, png_handler.info_ptr, &width,  & exifPtr) == __PNG_INFO_eXIf ) ){
}
{
}
{
