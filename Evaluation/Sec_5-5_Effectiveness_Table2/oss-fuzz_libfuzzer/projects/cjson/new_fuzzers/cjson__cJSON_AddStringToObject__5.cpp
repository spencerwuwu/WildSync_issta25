...
char* __dynsec_anonymous_group__groupname;
__dynsec_anonymous_group__groupname = __fuzz_0;
...
// Extracted from: mosquitto: plugins/dynamic-security/groups.c_1
// TODO: very hacky. Who knows whether this will work
int __dynsec_anonymous_group = 5;
 if ( ( __dynsec_anonymous_group &&cJSON_AddStringToObject(json, "anonymousGroup",  __dynsec_anonymous_group__groupname) == NULL ) ){
}
