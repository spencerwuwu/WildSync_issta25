...
if (_IN_BUFFER_SIZE < sizeof(cmsUInt32Number) + sizeof(cmsUInt32Number) + 1) {
	return 0;
}
...
// Extracted from: ghostscript: lcms2mt/src/cmstypes.c_3
// TODO: very hacky. Who knows whether this will work
int __cmsUInt32Number = 5;
 cmsUInt32Number i, n;
 n = SizeOfTag / sizeof ( __fuzz_0 );
 array_double = ( cmsFloat64Number * )_cmsCalloc(0,  n,  sizeof ( cmsFloat64Number ));
{
}
