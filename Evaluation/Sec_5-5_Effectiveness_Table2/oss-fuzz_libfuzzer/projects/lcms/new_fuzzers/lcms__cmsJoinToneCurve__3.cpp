...
if (_IN_BUFFER_SIZE < sizeof(cmsUInt32Number) + sizeof(cmsContext) + 1) {
	return 0;
}
...
nPoints = __fuzz_0;
cmsContext __fuzz_1;
memcpy(&__fuzz_1, _IN_BUFFER + _BUF_POINTER, sizeof(cmsContext));
...
// Extracted from: ghostscript: lcms2mt/src/cmsgmt.c_0
// TODO: very hacky. Who knows whether this will work
int __cmsUInt32Number = 5;
int __cmsContext = 5;
 KTone =cmsJoinToneCurve( ContextID, gamma18, gamma18,  nPoints);
