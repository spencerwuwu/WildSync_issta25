...
int __attachmentsi_size;
__attachmentsi_size = __fuzz_0;
...
char* __attachmentsi_data;
__attachmentsi_data = __fuzz_1;
...
int __fctx = 5;
int __sctx0 = 5;
int __attachments_size = 5;
 if ( __fctx ){
}
 if ( __sctx0 ){
 for ( i = 0;
 i < __attachments_size;
 i ++ )ass_add_font(ass_library,  ( char * ) " ",  ( char * ) __attachmentsi_data,  __attachmentsi_size);
{
}
}
