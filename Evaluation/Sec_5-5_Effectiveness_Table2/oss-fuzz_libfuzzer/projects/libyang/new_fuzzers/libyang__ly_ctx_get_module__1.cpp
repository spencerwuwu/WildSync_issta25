...
char* revision;
revision = malloc(__fuzz_0_LEN + 1);
memcpy(revision, __fuzz_0, __fuzz_0_LEN);
revision[__fuzz_0_LEN] = 0;
char* __fuzz_1 = (char*) (_IN_BUFFER + _BUF_POINTER);
size_t __fuzz_1_LEN = _IN_REMAIN_LEN;
_BUF_POINTER += __fuzz_1_LEN;

char* name;
name = malloc(__fuzz_1_LEN + 1);
memcpy(name, __fuzz_1, __fuzz_1_LEN);
name[__fuzz_1_LEN] = 0;
...
// initializing mod from parameter
