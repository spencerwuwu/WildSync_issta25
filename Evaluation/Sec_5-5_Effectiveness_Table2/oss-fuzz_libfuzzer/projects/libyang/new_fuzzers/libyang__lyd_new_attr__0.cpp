...
char* lang;
lang = malloc(__fuzz_0_LEN + 1);
memcpy(lang, __fuzz_0, __fuzz_0_LEN);
lang[__fuzz_0_LEN] = 0;
...
// Extracted from: libnetconf2: src/messages_server.c_0
 struct lyd_attr * attr;
 if ( tree ){
}
 if ( ( lang &&lyd_new_attr(tree,  NULL, "xml:lang",  lang,  & attr) ) ){
}
