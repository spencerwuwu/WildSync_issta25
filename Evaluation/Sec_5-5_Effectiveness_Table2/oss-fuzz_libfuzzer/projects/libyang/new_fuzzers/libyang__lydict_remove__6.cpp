...
char* __err__message_lang;
__err__message_lang = malloc(__fuzz_0_LEN + 1);
memcpy(__err__message_lang, __fuzz_0, __fuzz_0_LEN);
__err__message_lang[__fuzz_0_LEN] = 0;
...
lydict_remove(ctx,  __err__message_lang);
