...
// Extracted from: graphviz: plugin/gs/gvloadimage_gs.c_0
...
int __us__y = 5;
int __us__h = 5;
 __gs__surface =cairo_surface_create_similar (cairo_get_target(cr), CAIRO_CONTENT_COLOR_ALPHA, __us__x + __us__w, __us__y + __us__h );
