...
// Extracted from: weston: clients/stacking.c_0
// TODO: very hacky. Who knows whether this will work
int __font_extents_height = 5;
int __text_extents_x_advance = 5;
cairo_font_extents ( cr, & font_extents );
 while ( * p ){
 if ( end ){
}
cairo_text_extents ( cr, p, & text_extents );
cairo_rel_move_to(cr,  - __text_extents_x_advance,  __font_extents_height);
}
