...
// Extracted from: mosquitto: plugins/dynamic-security/plugin.c_0
 if ( (cJSON_AddStringToObject ( json,"command","getDefaultACLAccess" ) == NULL || ( ( j_data =cJSON_AddObjectToObject(json, "data") ) == NULL ) ) ){
}
