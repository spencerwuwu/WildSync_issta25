...
// Extracted from: mosquitto: plugins/dynamic-security/clients.c_0
 if ( (cJSON_AddStringToObject ( json,"command","getClient" ) == NULL || ( j_data =cJSON_AddObjectToObject(json, "data") ) == NULL || ( correlation_data &&cJSON_AddStringToObject ( json,"correlationData", correlation_data ) == NULL ) ) ){
}
