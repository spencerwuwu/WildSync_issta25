...
// Extracted from: graphicsmagick: tiff/contrib/addtiffo/tif_overview.c_0
TIFFErrorExt (TIFFClientdata(tif), "  TIFF_WriteOverview  ", "  File `%s' has too many directories.   \n   ",TIFFFileName ( tif ) );
