...
// Extracted from: guetzli: third_party/butteraugli/butteraugli/butteraugli_main.cc_0
 png_bytep * row_pointers =png_get_rows(png_handler.png_ptr, png_handler.info_ptr);
