...
// Extracted from: graphicsmagick: png/pngtest.c_0
 struct user_chunk_data * my_user_chunk_data = ( struct user_chunk_data * )png_get_user_chunk_ptr(png_handler.png_ptr);
