...
// Extracted from: podofo-0.9: podofo/branches/PODOFO_0_9_7_BRANCH/src/podofo/doc/PdfImage.cpp_0
// TODO: very hacky. Who knows whether this will work
int __PNG_INFO_tRNS = 5;
{
}
 png_bytep paletteTrans;
 int numTransColors;
 if ( ( color_type & PNG_COLOR_MASK_ALPHA || ( color_type == PNG_COLOR_TYPE_PALETTE &&png_get_valid ( png_handler.png_ptr, png_handler.info_ptr, __PNG_INFO_tRNS ) &&png_get_tRNS(png_handler.png_ptr, png_handler.info_ptr,  & paletteTrans,  & numTransColors,  NULL) ) ) ){
}
