...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_encoder_cnt.c_0
// TODO: very hacky. Who knows whether this will work
int __pdf__mmgr = 5;
int __ETen_B5_H_Init = 5;
int __ETen_B5_V_Init = 5;
 HPDF_Encoder encoder;
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"ETen-B5-H", __ETen_B5_H_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"ETen-B5-V", __ETen_B5_V_Init );
