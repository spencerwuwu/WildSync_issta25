...
if (_IN_BUFFER_SIZE < sizeof(struct lyd_meta**) + sizeof(struct lyd_attr*) + 1) {
	return 0;
}
size_t _IN_REMAIN_LEN = (_IN_BUFFER_SIZE - _BUF_POINTER) / 3;

struct lyd_meta** __fuzz_0 = (struct lyd_meta**) (_IN_BUFFER + _BUF_POINTER);
size_t __fuzz_0_LEN = _IN_REMAIN_LEN;
_BUF_POINTER += __fuzz_0_LEN;

struct lyd_meta** meta;
meta = __fuzz_0;
struct lyd_attr* __fuzz_1 = (struct lyd_attr*) (_IN_BUFFER + _BUF_POINTER);
...
// Extracted from: sysrepo: src/ly_wrap.c_0
 lyrc =lyd_new_meta2(ctx, tree,  0,  attr,  meta);
