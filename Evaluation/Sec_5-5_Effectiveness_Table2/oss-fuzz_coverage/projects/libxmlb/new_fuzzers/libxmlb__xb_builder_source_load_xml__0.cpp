...
gchar* xml;
xml = malloc(__fuzz_0_LEN + 1);
memcpy(xml, __fuzz_0, __fuzz_0_LEN);
xml[__fuzz_0_LEN] = 0;
...
// Extracted from: fwupd: libfwupdplugin/fu-firmware.c_0
 if ( ( !xb_builder_source_load_xml(source,  xml, XB_BUILDER_SOURCE_FLAG_WATCH_FILE |
