...
// Extracted from: fwupd: src/fu-cabinet.c_0
// TODO: very hacky. Who knows whether this will work
int __self__jcat_context = 5;
int __imgs__len = 5;
int __fixup1 = 5;
int __fu_cabinet_sort_priority_cb = 5;
 if (g_getenv ("FWUPD_XMLB_VERBOSE" ) != NULL ){
}
 if ( __self__jcat_context != NULL ){
 for ( guint i = 0;
 i < __imgs__len;
 i ++ ){
}
 ...
 __fixup1 =xb_builder_fixup_new ("OrderByPriority", __fu_cabinet_sort_priority_cb, NULL, NULL );
xb_builder_add_fixup(builder,  __fixup1);
