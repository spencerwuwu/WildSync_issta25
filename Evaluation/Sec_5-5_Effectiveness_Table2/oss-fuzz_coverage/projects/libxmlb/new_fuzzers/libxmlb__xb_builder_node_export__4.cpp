...
// Extracted from: fwupd: libfwupdplugin/fu-quirks.c_0
// TODO: very hacky. Who knows whether this will work
int __helper__root = 5;
 __helper__root =xb_builder_node_new ("quirk" );
 xml =xb_builder_node_export( __helper__root, XB_NODE_EXPORT_FLAG_FORMAT_MULTILINE |
			  XB_NODE_EXPORT_FLAG_FORMAT_INDENT, &error);
