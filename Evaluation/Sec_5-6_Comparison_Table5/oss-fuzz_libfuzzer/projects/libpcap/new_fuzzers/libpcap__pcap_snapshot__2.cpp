...
// Extracted from: tcpreplay: src/tcprewrite.c_0
// TODO: very hacky. Who knows whether this will work
int __options_infile = 5;
warnx ("%s was captured using a snaplen of %d bytes.  This may mean you have truncated packets.", __options_infile,pcap_snapshot(pkts) );
