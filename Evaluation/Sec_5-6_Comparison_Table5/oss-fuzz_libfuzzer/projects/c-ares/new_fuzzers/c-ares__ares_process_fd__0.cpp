...
if (_IN_BUFFER_SIZE < sizeof(ares_socket_t) + sizeof(ares_socket_t) + 1) {
	return 0;
}
...
writefd = __fuzz_0;
ares_socket_t __fuzz_1;
memcpy(&__fuzz_1, _IN_BUFFER + _BUF_POINTER, sizeof(ares_socket_t));
_BUF_POINTER += sizeof(ares_socket_t);
...
// Extracted from: aria2: src/AsyncNameResolver.cc_0
