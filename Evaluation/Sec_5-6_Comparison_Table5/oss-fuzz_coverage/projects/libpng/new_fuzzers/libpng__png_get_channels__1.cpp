...
// Extracted from: qt6-base: src/gui/image/qpnghandler.cpp_0
// TODO: very hacky. Who knows whether this will work
int __PNG_INFO_tRNS = 5;
 if ( ( bit_depth == 16 &&png_get_channels(png_handler.png_ptr, png_handler.info_ptr) == 1 && !png_get_valid ( png_handler.png_ptr, png_handler.info_ptr, __PNG_INFO_tRNS ) ) ){
}
