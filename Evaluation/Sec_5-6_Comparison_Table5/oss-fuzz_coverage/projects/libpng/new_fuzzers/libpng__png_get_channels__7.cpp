...
// Extracted from: sdl2_image: external/libpng/contrib/tools/pngcp.c_0
// TODO: very hacky. Who knows whether this will work
int __dp__bpp = 5;
 __dp__bpp =png_get_bit_depth ( png_handler.png_ptr, png_handler.info_ptr ) *png_get_channels(png_handler.png_ptr, png_handler.info_ptr);
