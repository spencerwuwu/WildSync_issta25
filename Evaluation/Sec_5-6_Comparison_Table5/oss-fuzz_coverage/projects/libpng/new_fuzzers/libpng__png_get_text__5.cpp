...
// Extracted from: graphicsmagick: png/contrib/tools/pngcp.c_0
// TODO: very hacky. Who knows whether this will work
int __dp__num_text = 5;
 png_textp chunks = NULL;
 __dp__num_text =png_get_text(png_handler.png_ptr, png_handler.info_ptr,  & chunks,  NULL);
