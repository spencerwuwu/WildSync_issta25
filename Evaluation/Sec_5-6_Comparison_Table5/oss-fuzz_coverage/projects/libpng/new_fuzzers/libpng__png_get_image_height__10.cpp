...
// Extracted from: darktable: src/imageio/format/png.c_0
// TODO: very hacky. Who knows whether this will work
int __png__global_height = 5;
 __png__global_height =png_get_image_height(png_handler.png_ptr, png_handler.info_ptr);
