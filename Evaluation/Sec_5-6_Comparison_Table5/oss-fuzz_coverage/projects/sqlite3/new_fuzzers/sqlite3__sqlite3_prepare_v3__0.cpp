...
if (_IN_BUFFER_SIZE < sizeof(size_t) + sizeof(sqlite3_stmt**) + 1) {
	return 0;
}
size_t __fuzz_0;
...
// Extracted from: lighttpd: src/mod_webdav.c_0
 if ( (sqlite3_prepare_v3(cx.db, zSql,  qsz,  SQLITE_PREPARE_PERSISTENT,  &stmt,  NULL) != SQLITE_OK ) ){
}
