...
if (_IN_BUFFER_SIZE < sizeof(int*) + sizeof(int*) + sizeof(char***) + 1) {
	return 0;
}
...
// Extracted from: gerbera: src/database/sqlite3/sl_task.cc_0
 int ret =sqlite3_get_table(cx.db, zSql,  & __pres__table,  & __pres__nrow,  & __pres__ncolumn, &zErrMsg);
