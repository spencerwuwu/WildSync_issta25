...
// Extracted from: mosquitto: apps/mosquitto_ctrl/dynsec.c_0
 if ( ( ( j_clients =cJSON_AddArrayToObject ( json,"clients" ) ) == NULL || ( j_roles =cJSON_AddArrayToObject ( json,"roles" ) ) == NULL || ( j_default_access =cJSON_AddObjectToObject(json, "defaultACLAccess") ) == NULL ) ){
}
