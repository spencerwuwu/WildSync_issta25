...
// Extracted from: libretro-genesis-plus-gx: core/cd_hw/cdd.c_0
// TODO: very hacky. Who knows whether this will work
int __cdd_toc_last = 5;
int __cdd_toc_trackscdd_toc_last_end = 5;
int __cdd_toc_trackscdd_toc_last_start = 5;
 __cdd_toc_trackscdd_toc_last_end = __cdd_toc_trackscdd_toc_last_start + ( (ov_pcm_total(&vf,  -1) + 587 ) / 588 );
