...
// Extracted from: fwupd: src/fu-engine.c_0
// TODO: very hacky. Who knows whether this will work
int __checksums__len = 5;
int __component = 5;
int __guids__len = 5;
 if ( __checksums__len == 0 ){
}
 __component =xb_builder_node_insert ( NULL,"component","type","firmware", NULL );
 for ( guint i = 0;
 i < __guids__len;
 i ++ ){
}
...
xb_builder_import_node(builder,  __component);
