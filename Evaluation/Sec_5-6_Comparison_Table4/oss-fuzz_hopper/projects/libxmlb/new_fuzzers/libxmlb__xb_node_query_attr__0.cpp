...
gchar* __fuzz_gchar_0;
__fuzz_gchar_0 = malloc(__fuzz_0_LEN + 1);
memcpy(__fuzz_gchar_0, __fuzz_0, __fuzz_0_LEN);
__fuzz_gchar_0[__fuzz_0_LEN] = 0;

gchar* __fuzz_1 = (gchar*) (_IN_BUFFER + _BUF_POINTER);
size_t __fuzz_1_LEN = _IN_REMAIN_LEN;
_BUF_POINTER += __fuzz_1_LEN;

gchar* __fuzz_gchar_1;
__fuzz_gchar_1 = malloc(__fuzz_1_LEN + 1);
memcpy(__fuzz_gchar_1, __fuzz_1, __fuzz_1_LEN);
__fuzz_gchar_1[__fuzz_1_LEN] = 0;
...
// Extracted from: gnome-software: lib/gs-appstream.c_0
 date_str =xb_node_query_attr(n, __fuzz_gchar_0, __fuzz_gchar_1, &error);
