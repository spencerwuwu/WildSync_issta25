...
// Extracted from: libvips: libvips/foreign/heifload.c_1
// TODO: very hacky. Who knows whether this will work
int __heif__page_width = 5;
int __heif__page_height = 5;
int __heif__bits_per_pixel = 5;
 if ( (heif_image_handle_get_width ( primary_handle ) != __heif__page_width ||heif_image_handle_get_height ( primary_handle ) != __heif__page_height ||heif_image_handle_get_luma_bits_per_pixel(primary_handle) != __heif__bits_per_pixel ) ){
}
