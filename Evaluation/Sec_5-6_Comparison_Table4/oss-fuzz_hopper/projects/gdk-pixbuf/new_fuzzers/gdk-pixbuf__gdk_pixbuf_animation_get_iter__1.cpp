...
// Extracted from: gthumb: gthumb/gth-image-viewer.c_0
// TODO: very hacky. Who knows whether this will work
int __self__priv__time = 5;
int __self__priv__iter = 5;
 if ( anim != NULL ){
g_get_current_time ( & __self__priv__time );
 __self__priv__iter =gdk_pixbuf_animation_get_iter(anim,  & __self__priv__time);
}
