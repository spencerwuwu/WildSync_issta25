...
int __private__animation_iter = 5;
int __private__animation_time = 5;
 if ( __private__animation_iter == NULL ){
 __private__animation_iter =gdk_pixbuf_animation_get_iter(anim,  & __private__animation_time);
}
