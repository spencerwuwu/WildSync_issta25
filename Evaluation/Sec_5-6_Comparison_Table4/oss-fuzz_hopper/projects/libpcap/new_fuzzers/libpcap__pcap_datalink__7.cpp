...
// Extracted from: fwknop: server/pcap_capture.c_0
// TODO: very hacky. Who knows whether this will work
int __opts__data_link_offset = 5;
 switch (pcap_datalink(pkts) ){
 case DLT_EN10MB:
 __opts__data_link_offset = 14;
 break;
 case DLT_PPP_ETHER:
 __opts__data_link_offset = 8;
 break;
 case DLT_LINUX_SLL:
 __opts__data_link_offset = 16;
 break;
 case DLT_LOOP:
 set_direction = 0;
 __opts__data_link_offset = 4;
 break;
 case DLT_NULL:
 set_direction = 0;
 __opts__data_link_offset = 4;
