...
// Extracted from: postgresql: src/interfaces/libpq/fe-gssapi-common.c_0
 major =gss_acquire_cred(&minor,  GSS_C_NO_NAME,  0,  GSS_C_NO_OID_SET,  GSS_C_INITIATE, &deleg_cred,  NULL, &minor);
