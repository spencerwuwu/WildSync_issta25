...
char* encoding_name;
encoding_name = malloc(__fuzz_0_LEN + 1);
memcpy(encoding_name, __fuzz_0, __fuzz_0_LEN);
encoding_name[__fuzz_0_LEN] = 0;
...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_doc.c_1
