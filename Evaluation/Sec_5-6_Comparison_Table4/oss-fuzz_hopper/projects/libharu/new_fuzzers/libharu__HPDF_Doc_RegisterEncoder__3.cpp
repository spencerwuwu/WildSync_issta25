...
int __GB_EUC_H_Init = 5;
int __GB_EUC_V_Init = 5;
 ...
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"GB-EUC-H", __GB_EUC_H_Init );
 encoder =HPDF_CMapEncoder_New ( __pdf__mmgr,"GB-EUC-V", __GB_EUC_V_Init );
