...
if (_IN_BUFFER_SIZE < sizeof(HPDF_Shading) + 1) {
	return 0;
}
HPDF_Shading __fuzz_0;
memcpy(&__fuzz_0, _IN_BUFFER + _BUF_POINTER, sizeof(HPDF_Shading));
_BUF_POINTER += sizeof(HPDF_Shading);
