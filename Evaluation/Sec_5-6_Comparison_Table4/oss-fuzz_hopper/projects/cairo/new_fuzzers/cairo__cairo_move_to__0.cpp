...
// Extracted from: tcpflow: src/netviz/packetfall.cpp_0
// TODO: very hacky. Who knows whether this will work
int __bounds_width = 5;
int __extents_width = 5;
int __bounds_height = 5;
int __extents_height = 5;
 double text_x = __fuzz_1 + ( __bounds_width - __extents_width ) / 2.0;
 double text_y = __fuzz_0 + ( __bounds_height + __extents_height ) / 2.0;
