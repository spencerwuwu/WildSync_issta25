...
if (_IN_BUFFER_SIZE < sizeof(double) + 1) {
	return 0;
}
double __fuzz_0;
...
double __this__btnWidth;
__this__btnWidth = __fuzz_0;
...
// Extracted from: xournalpp: src/core/control/tools/EditSelection.cpp_0
cairo_rel_move_to(cr,  __this__btnWidth,  0);
