...
if (_IN_BUFFER_SIZE < sizeof(double) + sizeof(double) + sizeof(double) + sizeof(double) + sizeof(double) + sizeof(double) + 1) {
	return 0;
}
double __fuzz_0;
...
double x_label_centering_pad;
x_label_centering_pad = __fuzz_4;
double __fuzz_5;
...
// Extracted from: tcpflow: src/netviz/plot_view.cpp_0
// TODO: very hacky. Who knows whether this will work
int __axis_label_extents_height = 5;
 double x = __fuzz_1 - gap;
 double y = __fuzz_0 - __axis_label_extents_height / 3.0;
