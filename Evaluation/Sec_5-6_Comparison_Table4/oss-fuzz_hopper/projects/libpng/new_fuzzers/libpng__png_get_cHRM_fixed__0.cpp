...
// Extracted from: skia-sharp: externals/skia/src/codec/SkPngCodec.cpp_0
...
int __chrm6 = 5;
int __chrm7 = 5;
 if ( (png_get_cHRM_fixed(png_handler.png_ptr, png_handler.info_ptr,  & __chrm0,  & __chrm1,  & __chrm2,  & __chrm3,  & __chrm4,  & __chrm5,  & __chrm6,  & __chrm7) ) ){
}
