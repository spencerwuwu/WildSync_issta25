...
char* __err__severity;
__err__severity = malloc(__fuzz_0_LEN + 1);
memcpy(__err__severity, __fuzz_0, __fuzz_0_LEN);
__err__severity[__fuzz_0_LEN] = 0;
...
lydict_remove(ctx,  __err__severity);
