...
char* __err__nsi;
__err__nsi = malloc(__fuzz_0_LEN + 1);
memcpy(__err__nsi, __fuzz_0, __fuzz_0_LEN);
__err__nsi[__fuzz_0_LEN] = 0;
...
// Extracted from: libnetconf2: src/messages_client.c_0
// TODO: very hacky. Who knows whether this will work
int __err__attr_count = 5;
int __err__elem_count = 5;
int __err__ns_count = 5;
 for ( i = 0;
 i < __err__attr_count;
 ++ i ){
}
