...
char* filepath;
filepath = malloc(__fuzz_0_LEN + 1);
memcpy(filepath, __fuzz_0, __fuzz_0_LEN);
filepath[__fuzz_0_LEN] = 0;
...
// Extracted from: frr: mgmtd/mgmt_ds.c_0
 ret =lyd_parse_data_path(ctx,  filepath, LYD_JSON,  LYD_PARSE_NO_STATE | LYD_PARSE_STRICT, LYD_VALIDATE_PRESENT, &tree);
