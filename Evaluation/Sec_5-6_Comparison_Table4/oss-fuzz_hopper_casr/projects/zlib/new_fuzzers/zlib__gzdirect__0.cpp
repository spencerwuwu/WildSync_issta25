...
char* buff4;
buff4 = malloc(__fuzz_0_LEN + 1);
memcpy(buff4, __fuzz_0, __fuzz_0_LEN);
buff4[__fuzz_0_LEN] = 0;
...
// Extracted from: libxml2: xmlIO.c_0
 if ( ( (gzread ( out, buff4, 4 ) > 0 ) && (gzdirect(out) == 0 ) ) ){
}
