...
if (_IN_BUFFER_SIZE < sizeof(MDB_cursor*) + 1) {
	return 0;
}
size_t _IN_REMAIN_LEN = (_IN_BUFFER_SIZE - _BUF_POINTER) / 2;

MDB_cursor* __fuzz_0 = (MDB_cursor*) (_IN_BUFFER + _BUF_POINTER);
...
// Extracted from: 389-ds-base: ldap/servers/slapd/back-ldbm/db-mdb/mdb_layer.c_0
// TODO: very hacky. Who knows whether this will work
int __dbmdb_data__dbi_flags = 5;
 MDB_cursor * dbmdb_cur;
 dbmdb_cur = ( MDB_cursor * ) __fuzz_0;
mdb_dbi_flags(NULL, mdb_cursor_dbi ( dbmdb_cur ),  & __dbmdb_data__dbi_flags);
{
}
