...
// Extracted from: sfizz-lv2: external/st_audiofile/thirdparty/dr_libs/old/dr_2d.h_0
// TODO: very hacky. Who knows whether this will work
int __pCairoData__pCairoContext = 5;
 __pCairoData__pCairoContext =cairo_reference(cr);
