...
char* __fuzz_char;
__fuzz_char = (char*)malloc(__fuzz_0_LEN + 1);
memcpy(__fuzz_char, __fuzz_0, __fuzz_0_LEN);
__fuzz_char[__fuzz_0_LEN] = 0;
...
// Extracted from: ghostscript: libpng/pngwio.c_0
png_warning(png_handler.png_ptr, __fuzz_char);
