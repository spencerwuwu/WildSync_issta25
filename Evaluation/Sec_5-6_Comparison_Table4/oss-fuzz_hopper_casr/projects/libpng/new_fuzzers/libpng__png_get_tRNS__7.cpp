...
// Extracted from: sdl2_image: external/libpng/contrib/libtests/pngvalid.c_1
// TODO: very hacky. Who knows whether this will work
int __PNG_INFO_tRNS = 5;
 png_color_16p trans_color = 0;
 if ( (png_get_tRNS(png_handler.png_ptr, png_handler.info_ptr,  0,  0,  & trans_color) & __PNG_INFO_tRNS ) ){
}
