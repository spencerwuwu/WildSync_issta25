...
// Extracted from: openimageio: src/png.imageio/png_pvt.h_0
// TODO: very hacky. Who knows whether this will work
int __interlace_type = 5;
 __interlace_type =png_get_interlace_type(png_handler.png_ptr, png_handler.info_ptr);
