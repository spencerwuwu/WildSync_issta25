...
// Extracted from: darktable: src/imageio/imageio_png.c_0
// TODO: very hacky. Who knows whether this will work
int __png__color_type = 5;
 __png__color_type =png_get_color_type(png_handler.png_ptr, png_handler.info_ptr);
