...
// Extracted from: graphicsmagick: webp/imageio/pngdec.c_0
 int srgb_intent;
 if ( (png_get_sRGB(png_handler.png_ptr, png_handler.info_ptr,  & srgb_intent) ||png_get_gAMA ( png_handler.png_ptr, png_handler.info_ptr, & image_gamma ) ) ){
}
