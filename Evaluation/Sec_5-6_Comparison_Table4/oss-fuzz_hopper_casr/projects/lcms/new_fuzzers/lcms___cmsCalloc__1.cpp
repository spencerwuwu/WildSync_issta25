...
cmsUInt32Number * ElementOffsets;

/**** End of fuzz variables initialization code ****/
if( size==0)return 0;
cmsHANDLE handle = cmsIT8LoadFromMem(0, (void *)data, size);
/**** Start of extracted external code ****/
// Extracted from: ghostscript: lcms2mt/src/cmstypes.c_0
 ElementOffsets = ( cmsUInt32Number * )_cmsCalloc(0,  Count,  sizeof ( cmsUInt32Number ));
