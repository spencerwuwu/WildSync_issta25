...
if (_IN_BUFFER_SIZE < sizeof(HPDF_XObject) + 1) {
	return 0;
}
HPDF_XObject __fuzz_0;
memcpy(&__fuzz_0, _IN_BUFFER + _BUF_POINTER, sizeof(HPDF_XObject));
_BUF_POINTER += sizeof(HPDF_XObject);
