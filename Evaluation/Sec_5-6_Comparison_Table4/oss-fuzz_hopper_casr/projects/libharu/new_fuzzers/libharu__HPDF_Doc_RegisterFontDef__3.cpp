...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_fontdef_cnt.c_0
// TODO: very hacky. Who knows whether this will work
int __pdf__mmgr = 5;
int __MingLiU_Init = 5;
int __MingLiU_Bold_Init = 5;
int __MingLiU_Italic_Init = 5;
int __MingLiU_BoldItalic_Init = 5;
 HPDF_FontDef fontdef;
 fontdef =HPDF_CIDFontDef_New ( __pdf__mmgr,"MingLiU", __MingLiU_Init );
 fontdef =HPDF_CIDFontDef_New ( __pdf__mmgr,"MingLiU,Bold", __MingLiU_Bold_Init );
 fontdef =HPDF_CIDFontDef_New ( __pdf__mmgr,"MingLiU,Italic", __MingLiU_Italic_Init );
 fontdef =HPDF_CIDFontDef_New ( __pdf__mmgr,"MingLiU,BoldItalic", __MingLiU_BoldItalic_Init );
