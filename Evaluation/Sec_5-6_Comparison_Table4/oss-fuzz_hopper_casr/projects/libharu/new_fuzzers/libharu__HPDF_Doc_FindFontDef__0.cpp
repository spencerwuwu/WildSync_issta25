...
char* __fontdef__base_font;
__fontdef__base_font = malloc(__fuzz_0_LEN + 1);
memcpy(__fontdef__base_font, __fuzz_0, __fuzz_0_LEN);
__fontdef__base_font[__fuzz_0_LEN] = 0;
...
// Extracted from: vtk: ThirdParty/libharu/vtklibharu/src/hpdf_doc.c_0
 if ( (HPDF_Doc_FindFontDef(pdf,  __fontdef__base_font) != NULL ) ){
}
