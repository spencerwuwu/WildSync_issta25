...
if (_IN_BUFFER_SIZE < sizeof(char*) + sizeof(HPDF_UINT) + sizeof(HPDF_PageNumStyle) + 1) {
	return 0;
}
HPDF_UINT __fuzz_1;
memcpy(&__fuzz_1, _IN_BUFFER + _BUF_POINTER, sizeof(HPDF_UINT));
_BUF_POINTER += sizeof(HPDF_UINT);

HPDF_UINT first_page;
first_page = __fuzz_1;
HPDF_PageNumStyle __fuzz_2;
memcpy(&__fuzz_2, _IN_BUFFER + _BUF_POINTER, sizeof(HPDF_PageNumStyle));
_BUF_POINTER += sizeof(HPDF_PageNumStyle);
