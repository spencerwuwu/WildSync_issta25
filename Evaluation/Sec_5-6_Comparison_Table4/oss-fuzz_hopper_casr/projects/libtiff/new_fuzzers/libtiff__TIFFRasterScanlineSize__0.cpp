...
// Extracted from: libgeotiff: libgeotiff/bin/geotifcp.c_0
 unsigned char * buf = ( unsigned char * )_TIFFmalloc (TIFFRasterScanlineSize(tif) * imagelength );
