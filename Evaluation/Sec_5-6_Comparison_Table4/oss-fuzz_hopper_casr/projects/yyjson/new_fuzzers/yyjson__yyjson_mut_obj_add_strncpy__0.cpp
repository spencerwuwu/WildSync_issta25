...
if (_IN_BUFFER_SIZE < sizeof(size_t) + sizeof(char*) + sizeof(char*) + sizeof(yyjson_mut_val*) + 1) {
	return 0;
}
size_t __fuzz_0;
...
char* __buf__chars;
__buf__chars = __fuzz_2;
yyjson_mut_val* __fuzz_3 = (yyjson_mut_val*) (_IN_BUFFER + _BUF_POINTER);
...
yyjson_mut_obj_add_strncpy(mdoc,  obj,  _key,  __buf__chars,  __buf__length);
